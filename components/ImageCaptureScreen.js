...
import { StyleSheet, Text, View, TouchableOpacity, Image, Dimensions, TextInput, Button, ActivityIndicator } from 'react-native';
    ...
    upload = async () => {
        ...
        fetch(CLOUDINARY_URL, {
            ...
            let memory = {
                ...
                "popularity": [50, Math.floor(Math.random() * 100), Math.floor(Math.random() * 100), Math.floor(Math.random() * 100), Math.floor(Math.random() * 100), Math.floor(Math.random() * 100)],
                "location": "Virginia Tech",
                "ARpopularity":[[-Math.floor(Math.random() * 4), Math.random(), -2],[-4, 0.25, -2],[-4, 0.8, -2],[-4, 0.3, -2],[-4, 0.6, -2],[-4, 1, -2]],
                "ARsize": 0.3,
                "ARrotation":[0,10,0],
                "related" : []
        ...
        return (
            <View>
                <View style={[styles.container, styles.horizontal]}>
                    <ActivityIndicator animating={this.state.isLoading} size="large" color="#00ff00" />
                </View>
                {this.state && this.state.uploaded 

                ?
                    <View>
                        <Text style={{color: "green", fontSize: 12, textAlign: "center"}}>Memory has been uploaded Successfully</Text>
                    </View>
