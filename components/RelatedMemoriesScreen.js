...
import {Text, View, Image, StyleSheet, SafeAreaView, Button, TouchableOpacity, Dimensions} from 'react-native';
        ...
        return(
            <View style={{backgroundColor: "black", height: "100%"}}>
                <View style={{marginTop: 30}}>
                    <Text style={{textAlign: 'center', color: "white"}}>Co-located Memories</Text>
                    <Carousel
                        layout="default"
                        layoutCardOffset={9}
                ...
                <View style={{marginTop: 30}}>
                    <Text style={{textAlign: 'center', color: "white"}}>Related Memories</Text>
                    {
                       this.state && this.state.memories[this.state.colocatedCurrentIndex].related &&
                       this.state.memories[this.state.colocatedCurrentIndex].related.length > 0 
                       ?
                        <Carousel
                                layout="default"
                                layoutCardOffset={9}
                            ...
                            />
                        :
                        <Text style={{textAlign: 'center', color: "white", marginTop: 30}}>No related Memories available for this memory</Text>
